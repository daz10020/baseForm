...
export const formGroupProps = {
  ...
  size: {
    type: String,
    default: 'small',
    validator: val => oneOf(val, SIZE_VALUE)
  },
  disabled: {
    type: Boolean,
    default: false
...
export const formItemProps = {
  itemType: {
    type: String,
    default: 'input',
    validator: val => oneOf(val, TYPE_VALUE)
  },
  label: String,
  labelWidth: String,
  prop: {
  ...
  inputType: {
    type: String,
    default: 'text',
    validator: val => oneOf(val, INPUT_VALUE)
  },
  // slot
  slots: {
    type: Array,
    default: () => ([]),
    validator: arr => arr.every(({ type }) => oneOf(type, SLOT_TYPE_VALUE))
  },
  // 文本框
  rows: Number,
  ...
  dateType: {
    type: String,
    default: 'date',
    validator: val => oneOf(val, DATE_VALUE)
  },
  // 输入框格式
  format: {
    type: String,
  ...
  method: {
    type: String,
    default: 'GET',
    validator: val => oneOf(val, METHODS)
  },
  // 数据位置
  resultPath: {
    type: Array,
